  ...
  return (
    <div className="mt-8 space-y-3">
      <div className="flex items-center gap-2">
        ...
        <h3 className="font-semibold text-slate-900">Historique des saisies</h3>
        <span className="text-xs text-slate-400">
          ({records.length} affichees sur {total})
        </span>
      </div>
      ...
      <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
        {records.length === 0 ? (
          <div className="px-4 py-8 text-center text-sm text-slate-500">
            Aucune saisie trouvee pour cette recherche.
          </div>
        ) : (
            ...
            <table className="min-w-full text-sm">
              <thead>
                <tr className="bg-slate-50 text-slate-500 text-xs border-b border-slate-100">
                  ...
                  <th className="text-right px-4 py-2.5 font-medium">Casses</th>
        ...
        {hasMore && (
          <div className="border-t border-slate-100 px-4 py-3 text-center">
            ...
            >
              Charger plus d&apos;anciennes saisies
            </button>
          </div>
        )}
      </div>
